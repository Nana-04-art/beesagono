...
describe('HiveControlsComponent', () => {
  ...
  it('should emit delete event when delete button is clicked', () => {
    ...
    const deleteBtn: HTMLButtonElement = fixture.nativeElement.querySelector('.control-btn--secondary');
  ...
  it('should emit shuffle event when shuffle button is clicked', () => {
    ...
    const shuffleBtn: HTMLButtonElement = fixture.nativeElement.querySelector('.control-btn--icon');
  ...
  it('should emit submit event when submit button is clicked', () => {
    ...
    const submitBtn: HTMLButtonElement = fixture.nativeElement.querySelector('.control-btn--primary');
